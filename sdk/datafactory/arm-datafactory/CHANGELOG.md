...
### Features Added
  ...
  - Class DataFactoryManagementClient has a new constructor "constructor(credential: TokenCredential, options?: DataFactoryManagementClientOptionalParams);"
...
### Breaking Changes
  ...
  - Class DataFactoryManagementClient no longer has parameter apiVersion
  - Class DataFactoryManagementClient no longer has parameter subscriptionId
