...
export interface DiscoveryRulesOperations {
    createOrUpdate: (resourceGroupName: string, healthModelName: string, discoveryRuleName: string, resource: DiscoveryRule, options?: DiscoveryRulesCreateOrUpdateOptionalParams) => PollerLike<OperationState<DiscoveryRule>, DiscoveryRule>;
