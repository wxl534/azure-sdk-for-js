...
### Features Added
  ...
  - Class HealthbotClient has a new constructor "constructor(credential: TokenCredential, options?: HealthbotClientOptionalParams);"
...
### Breaking Changes
  ...
  - Class HealthbotClient no longer has parameter apiVersion
  - Class HealthbotClient no longer has parameter subscriptionId
