...
import {
  _TargetComputeSizeCollection,
  _targetComputeSizeCollectionDeserializer,
  TargetComputeSize,
...
import { TargetComputeSizesListByReplicationProtectedItemsOptionalParams } from "./options.js";
import {
  StreamableMethod,
