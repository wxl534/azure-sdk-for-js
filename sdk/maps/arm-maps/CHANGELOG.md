...
### Breaking Changes
  ...
  - Class AzureMapsManagementClient no longer has parameter apiVersion
  - Class AzureMapsManagementClient no longer has parameter subscriptionId
