...
### Breaking Changes
  ...
  - Class SearchManagementClient no longer has parameter apiVersion
  - Class SearchManagementClient no longer has parameter subscriptionId
