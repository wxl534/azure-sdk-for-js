...
export function _listByStoragePoolSend(
  ...
  options: AvsVmsListByStoragePoolOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/PureStorage.Block/storagePools/{storagePoolName}/avsVms{?api%2Dversion}",
    {
...
export async function _listByStoragePoolDeserialize(
  ...
  return _avsVmListResultDeserializer(result.body);
}
...
export function _$deleteSend(
  ...
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/PureStorage.Block/storagePools/{storagePoolName}/avsVms/{avsVmId}{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
      resourceGroupName: resourceGroupName,
      storagePoolName: storagePoolName,
...
export async function _getDeserialize(result: PathUncheckedResponse): Promise<AvsVm> {
  ...
  return avsVmDeserializer(result.body);
}
