...
export function _listBySubscriptionSend(
  context: Client,
  options: OnlineExperimentationWorkspacesListBySubscriptionOptionalParams = { requestOptions: {} },
): StreamableMethod {
...
export function _$deleteSend(
  ...
  options: OnlineExperimentationWorkspacesDeleteOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export function _updateSend(
  ...
  options: OnlineExperimentationWorkspacesUpdateOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OnlineExperimentation/workspaces/{workspaceName}{?api%2Dversion}",
    {
...
export function _createOrUpdateSend(
  ...
  options: OnlineExperimentationWorkspacesCreateOrUpdateOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OnlineExperimentation/workspaces/{workspaceName}{?api%2Dversion}",
    {
...
export function _getSend(
  ...
  resourceGroupName: string,
  workspaceName: string,
  options: OnlineExperimentationWorkspacesGetOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OnlineExperimentation/workspaces/{workspaceName}{?api%2Dversion}",
    {
