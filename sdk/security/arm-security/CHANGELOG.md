...
### Features Added
  ...
  - Class SecurityCenter has a new constructor "constructor(credential: TokenCredential, options?: SecurityCenterOptionalParams);"
  - Class SecurityCenter has a new constructor "constructor(credential: TokenCredential, subscriptionId: string, options?: SecurityCenterOptionalParams);"
