...
### Features Added
  ...
  - Added operation DomainsOperations.cancelVerification
  - Added operation DomainsOperations.createOrUpdate
  - Added operation DomainsOperations.delete
  - Added operation DomainsOperations.initiateVerification
  - Added operation DomainsOperations.update
  - Added operation EmailServicesOperations.createOrUpdate
  - Added operation EmailServicesOperations.delete
  - Added operation EmailServicesOperations.update
...
### Breaking Changes
  - Operation Domains.beginCancelVerificationAndWait has a new signature
  - Operation Domains.beginInitiateVerificationAndWait has a new signature
  - Removed Interface CommunicationServiceResourceList
  - Removed Interface DomainResourceList
  - Removed Interface EmailServiceResourceList
  - Removed Interface ErrorDetailAutoGenerated
  - Removed Interface ErrorResponseAutoGenerated
  - Removed Interface SenderUsernameResourceCollection
  - Removed Interface SmtpUsernameResourceCollection
  - Removed Interface SuppressionListAddressResourceCollection
  - Removed Interface SuppressionListResourceCollection
...
### Features Added
  - Added operation group SmtpUsernames
  ...
  - Added Interface SmtpUsernameResourceCollection
  ...
  - Interface CommunicationServiceResource has a new optional parameter publicNetworkAccess
  - Interface CommunicationServiceResourceUpdate has a new optional parameter disableLocalAuth
  - Interface CommunicationServiceResourceUpdate has a new optional parameter publicNetworkAccess
  - Added Type Alias KeyType
  - Added Type Alias PublicNetworkAccess
  - Added Type Alias SmtpUsernamesCreateOrUpdateResponse
  - Added Type Alias SmtpUsernamesGetResponse
  - Added Type Alias SmtpUsernamesListNextResponse
  - Added Type Alias SmtpUsernamesListResponse
