 ...
 * x-ms-original-file: 2026-03-01/ConfigTemplates_UnLinkFromHierarchies_MaximumSet_Gen.json
 */
async function configTemplatesUnLinkFromHierarchiesMaximumSetGeneratedByMaximumSetRuleGeneratedByMaximumSetRuleGeneratedByMaximumSetRuleGeneratedByMaximumSetRuleGeneratedByMaximumSetRule(): Promise<void> {
...
async function main(): Promise<void> {
  await configTemplatesUnLinkFromHierarchiesMaximumSetGeneratedByMaximumSetRuleGeneratedByMaximumSetRuleGeneratedByMaximumSetRuleGeneratedByMaximumSetRuleGeneratedByMaximumSetRule();
}
