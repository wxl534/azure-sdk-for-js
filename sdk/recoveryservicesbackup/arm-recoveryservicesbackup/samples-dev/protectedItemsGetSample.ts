 ...
 * call the GetItemOperationResult API.
 * x-ms-original-file: 2026-02-01/AzureIaasVm/ClassicCompute_ProtectedItem_Get.json
 */
 ...
 * @summary provides the details of the backed up item. This is an asynchronous operation. To know the status of the operation,
 * call the GetItemOperationResult API.
 * x-ms-original-file: 2026-02-01/AzureIaasVm/Compute_ProtectedItem_Get.json
 */
