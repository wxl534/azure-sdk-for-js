...
import {
  ...
  ElasticBackupVault,
  elasticBackupVaultSerializer,
  elasticBackupVaultDeserializer,
  ElasticBackupVaultUpdate,
  elasticBackupVaultUpdateSerializer,
  _ElasticBackupVaultListResult,
  _elasticBackupVaultListResultDeserializer,
...
export function _listByElasticAccountSend(
  ...
  accountName: string,
  options: ElasticBackupVaultsListByElasticAccountOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/elasticAccounts/{accountName}/elasticBackupVaults{?api%2Dversion}",
    {
...
export async function _listByElasticAccountDeserialize(
...
): Promise<_ElasticBackupVaultListResult> {
  ...
  return _elasticBackupVaultListResultDeserializer(result.body);
}
...
export function _$deleteSend(
  ...
  options: ElasticBackupVaultsDeleteOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/elasticAccounts/{accountName}/elasticBackupVaults/{backupVaultName}{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
      resourceGroupName: resourceGroupName,
      accountName: accountName,
...
export function _updateSend(
  ...
  options: ElasticBackupVaultsUpdateOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/elasticAccounts/{accountName}/elasticBackupVaults/{backupVaultName}{?api%2Dversion}",
    {
  ...
  return context
    ...
    .patch({
      ...
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: elasticBackupVaultUpdateSerializer(body),
    });
}
...
export async function _updateDeserialize(
  ...
  return elasticBackupVaultDeserializer(result.body);
}
...
export function update(
  ...
  return getLongRunningPoller(context, _updateDeserialize, ["200", "202", "201"], {
    ...
    resourceLocationConfig: "location",
    apiVersion: context.apiVersion ?? "2026-03-15-preview",
  }) as PollerLike<OperationState<ElasticBackupVault>, ElasticBackupVault>;
}
...
export function _createOrUpdateSend(
  ...
  options: ElasticBackupVaultsCreateOrUpdateOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/elasticAccounts/{accountName}/elasticBackupVaults/{backupVaultName}{?api%2Dversion}",
    {
  ...
  return context
    ...
    .put({
      ...
      contentType: "application/json",
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: elasticBackupVaultSerializer(body),
    });
}
...
export function _getSend(
  ...
  accountName: string,
  backupVaultName: string,
  options: ElasticBackupVaultsGetOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/elasticAccounts/{accountName}/elasticBackupVaults/{backupVaultName}{?api%2Dversion}",
    {
...
export async function _getDeserialize(result: PathUncheckedResponse): Promise<ElasticBackupVault> {
  const expectedStatuses = ["200"];
  if (!expectedStatuses.includes(result.status)) {
    const error = createRestError(result);
    if (result.body) {
