...
### Features Added
  ...
  - Class PeeringManagementClient has a new constructor "constructor(credential: TokenCredential, options?: PeeringManagementClientOptionalParams);"
...
### Breaking Changes
  - Class PeeringManagementClient no longer has parameter apiVersion
  - Class PeeringManagementClient no longer has parameter subscriptionId
