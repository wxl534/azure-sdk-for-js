...
export function _stopAllAssignmentsSend(
  context: Client,
  resourceGroupName: string,
  storageTaskName: string,
  options: StorageTasksStopAllAssignmentsOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageActions/storageTasks/{storageTaskName}/stopAllAssignments{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
...
export async function _stopAllAssignmentsDeserialize(result: PathUncheckedResponse): Promise<void> {
...
export function stopAllAssignments(
  context: Client,
  resourceGroupName: string,
  storageTaskName: string,
  options: StorageTasksStopAllAssignmentsOptionalParams = { requestOptions: {} },
  ...
  return getLongRunningPoller(
    context,
    _stopAllAssignmentsDeserialize,
    ["202", "204", "200", "201"],
    {
      updateIntervalInMs: options?.updateIntervalInMs,
      abortSignal: options?.abortSignal,
      getInitialResponse: () =>
        _stopAllAssignmentsSend(context, resourceGroupName, storageTaskName, options),
