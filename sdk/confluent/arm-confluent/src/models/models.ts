...
export function apiKeyRecordDeserializer(item: any): APIKeyRecord {
  return {
    ...
    ...(!item["properties"]
      ? item["properties"]
      : _apiKeyRecordPropertiesDeserializer(item["properties"])),
  };
}
...
export function organizationResourceSerializer(item: OrganizationResource): any {
  return {
    ...
    properties: _organizationResourcePropertiesSerializer(item),
  };
}
...
export function regionRecordDeserializer(item: any): RegionRecord {
  return {
    ...
    ...(!item["properties"]
      ? item["properties"]
      : _regionRecordPropertiesDeserializer(item["properties"])),
  };
}
...
export function scEnvironmentRecordSerializer(item: SCEnvironmentRecord): any {
  return {
    kind: item["kind"],
    properties: areAllPropsUndefined(item, ["streamGovernanceConfig", "metadata"])
      ? undefined
      : _scEnvironmentRecordPropertiesSerializer(item),
  };
}
...
export function scEnvironmentRecordDeserializer(item: any): SCEnvironmentRecord {
  return {
    ...
    ...(!item["properties"]
      ? item["properties"]
      : _scEnvironmentRecordPropertiesDeserializer(item["properties"])),
  };
}
...
export function schemaRegistryClusterRecordDeserializer(item: any): SchemaRegistryClusterRecord {
  return {
    ...
    ...(!item["properties"]
      ? item["properties"]
      : _schemaRegistryClusterRecordPropertiesDeserializer(item["properties"])),
  };
}
...
export function scClusterRecordSerializer(item: SCClusterRecord): any {
  return {
    kind: item["kind"],
    properties: areAllPropsUndefined(item, ["metadata", "spec", "status"])
      ? undefined
      : _scClusterRecordPropertiesSerializer(item),
  };
}
...
export function scClusterRecordDeserializer(item: any): SCClusterRecord {
  return {
    ...
    ...(!item["properties"]
      ? item["properties"]
      : _scClusterRecordPropertiesDeserializer(item["properties"])),
  };
}
...
export function scClusterByokEntitySerializer(item: SCClusterByokEntity): any {
  return { id: item["id"], related: item["related"], resourceName: item["resourceName"] };
}
...
export function connectorResourceSerializer(item: ConnectorResource): any {
  return { properties: _connectorResourcePropertiesSerializer(item) };
}
...
export function connectorResourceDeserializer(item: any): ConnectorResource {
  return {
    ...
    systemData: !item["systemData"]
      ? item["systemData"]
      : systemDataDeserializer(item["systemData"]),
    ..._connectorResourcePropertiesDeserializer(item["properties"]),
  };
}
...
export function azureCosmosDBSinkConnectorServiceInfoSerializer(
  ...
  return {
    ...
    cosmosWriteDetails: item["cosmosWriteDetails"],
  };
}
...
export function azureCosmosDBSourceConnectorServiceInfoSerializer(
  ...
  return {
    ...
    cosmosIncludeAllContainers: item["cosmosIncludeAllContainers"],
  };
}
...
export function topicRecordSerializer(item: TopicRecord): any {
  return {
    properties: areAllPropsUndefined(item, [
      ...
      ? undefined
      : _topicRecordPropertiesSerializer(item),
  };
}
...
export function topicRecordDeserializer(item: any): TopicRecord {
  return {
    ...
    ...(!item["properties"]
      ? item["properties"]
      : _topicRecordPropertiesDeserializer(item["properties"])),
  };
}
...
export function confluentAgreementResourceSerializer(item: ConfluentAgreementResource): any {
  return {
    properties: areAllPropsUndefined(item, [
      ...
      ? undefined
      : _confluentAgreementResourcePropertiesSerializer(item),
  };
}
...
export function confluentAgreementResourceDeserializer(item: any): ConfluentAgreementResource {
  return {
    ...
    ...(!item["properties"]
      ? item["properties"]
      : _confluentAgreementResourcePropertiesDeserializer(item["properties"])),
  };
}
...
export enum KnownVersions {
  ...
  /** The 2025-07-17-preview API version. */
...
export function _organizationResourcePropertiesSerializer(item: OrganizationResource): any {
  return {
    offerDetail: offerDetailSerializer(item["offerDetail"]),
    userDetail: userDetailSerializer(item["userDetail"]),
    linkOrganization: !item["linkOrganization"]
...
export function _regionRecordPropertiesDeserializer(item: any) {
  return {
    metadata: !item["metadata"] ? item["metadata"] : scMetadataEntityDeserializer(item["metadata"]),
    spec: !item["spec"] ? item["spec"] : regionSpecEntityDeserializer(item["spec"]),
  };
...
export function _scEnvironmentRecordPropertiesSerializer(item: SCEnvironmentRecord): any {
  return {
    streamGovernanceConfig: !item["streamGovernanceConfig"]
      ? item["streamGovernanceConfig"]
      : streamGovernanceConfigSerializer(item["streamGovernanceConfig"]),
...
export function _scEnvironmentRecordPropertiesDeserializer(item: any) {
  return {
    streamGovernanceConfig: !item["streamGovernanceConfig"]
      ? item["streamGovernanceConfig"]
      : streamGovernanceConfigDeserializer(item["streamGovernanceConfig"]),
...
export function _schemaRegistryClusterRecordPropertiesDeserializer(item: any) {
  return {
    metadata: !item["metadata"] ? item["metadata"] : scMetadataEntityDeserializer(item["metadata"]),
    spec: !item["spec"] ? item["spec"] : schemaRegistryClusterSpecEntityDeserializer(item["spec"]),
    status: !item["status"]
...
export function _scClusterRecordPropertiesSerializer(item: SCClusterRecord): any {
  return {
    metadata: !item["metadata"] ? item["metadata"] : scMetadataEntitySerializer(item["metadata"]),
    spec: !item["spec"] ? item["spec"] : scClusterSpecEntitySerializer(item["spec"]),
    status: !item["status"] ? item["status"] : clusterStatusEntitySerializer(item["status"]),
...
export function _scClusterRecordPropertiesDeserializer(item: any) {
  return {
    metadata: !item["metadata"] ? item["metadata"] : scMetadataEntityDeserializer(item["metadata"]),
    spec: !item["spec"] ? item["spec"] : scClusterSpecEntityDeserializer(item["spec"]),
    status: !item["status"] ? item["status"] : clusterStatusEntityDeserializer(item["status"]),
...
export function _connectorResourcePropertiesSerializer(item: ConnectorResource): any {
  return {
    connectorBasicInfo: !item["connectorBasicInfo"]
      ? item["connectorBasicInfo"]
      : connectorInfoBaseSerializer(item["connectorBasicInfo"]),
...
export function _connectorResourcePropertiesDeserializer(item: any) {
  return {
    connectorBasicInfo: !item["connectorBasicInfo"]
      ? item["connectorBasicInfo"]
      : connectorInfoBaseDeserializer(item["connectorBasicInfo"]),
...
export function _topicRecordPropertiesSerializer(item: TopicRecord): any {
  return {
    kind: item["kind"],
    topicId: item["topicId"],
    metadata: !item["metadata"]
...
export function _topicRecordPropertiesDeserializer(item: any) {
  return {
    kind: item["kind"],
    topicId: item["topicId"],
    metadata: !item["metadata"]
...
export function _confluentAgreementResourcePropertiesSerializer(
  item: ConfluentAgreementResource,
): any {
  return {
    publisher: item["publisher"],
    product: item["product"],
...
export function _confluentAgreementResourcePropertiesDeserializer(item: any) {
  return {
    publisher: item["publisher"],
    product: item["product"],
    plan: item["plan"],
