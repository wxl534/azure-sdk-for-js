...
export function _getSchemaRegistryClusterByIdSend(
  ...
  environmentId: string,
  clusterId: string,
  options: OrganizationGetSchemaRegistryClusterByIdOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export function _listSchemaRegistryClustersSend(
  ...
  organizationName: string,
  environmentId: string,
  options: OrganizationListSchemaRegistryClustersOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export function _getEnvironmentByIdSend(
  ...
  organizationName: string,
  environmentId: string,
  options: OrganizationGetEnvironmentByIdOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export function _listBySubscriptionSend(
  context: Client,
  options: OrganizationListBySubscriptionOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export function _listByResourceGroupSend(
  context: Client,
  resourceGroupName: string,
  options: OrganizationListByResourceGroupOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export function _deleteClusterAPIKeySend(
  ...
  organizationName: string,
  apiKeyId: string,
  options: OrganizationDeleteClusterAPIKeyOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
