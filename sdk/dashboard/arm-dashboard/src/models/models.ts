...
export function managedGrafanaPropertiesSerializer(item: ManagedGrafanaProperties): any {
  return {
    ...
    apiKey: item["apiKey"],
    creatorCanAdmin: item["creatorCanAdmin"],
...
/**
 * The creator will have admin access for the Grafana instance. \
 * {@link KnownCreatorCanAdmin} can be used interchangeably with CreatorCanAdmin,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Disabled**: Creator admin access is disabled \
 * **Enabled**: Creator admin access is enabled
 */
