...
import { ModelsListOptionalParams } from "./options.js";
import {
  StreamableMethod,
...
export function _listSend(
  ...
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/providers/Microsoft.CognitiveServices/locations/{location}/models{?api%2Dversion}",
    {
...
export async function _listDeserialize(result: PathUncheckedResponse): Promise<_ModelListResult> {
